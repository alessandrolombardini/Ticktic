    ...
    <div class="roundend-corners col-12 col-md-8 bg-white border mt-2 mb-4 px-4 py-3 mr-0 shadow-sm concert-tickets">
        ...
        <div class="ticket-kind">
            <div class="row mt-3">
                ...
                <i class="col-2 col-md-1 fas fa-minus-circle menoCarrello fa-2x text-right m-0 px-0 pb-0 pt-md-1 pt-2 cursor-pointer"></i>
                ...
                <i class="col-2 col-md-1 fas fa-plus-circle piuCarrello fa-2x text-left m-0 px-0 pb-0 pt-md-1 pt-2 cursor-pointer"></i>
