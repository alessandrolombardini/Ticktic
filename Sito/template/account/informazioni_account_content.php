    ...
    <div class="row mt-2">
        <div class="roundend-corners col-12 col-md-12 bg-white border mt-2 mb-5 px-4 py-3 shadow-sm">
            <div class="row pt-3 mt-md-1">
                <div class = "col-12 col-md-3"><span class="font-weight-bold">Nome:  </span><?php echo$templateParams["account"]["Nome"]?></div>
                <div class = "col-12 col-md-4 mt-0"><span class="font-weight-bold">Cognome:  </span><?php echo$templateParams["account"]["Cognome"]?></div>
                <div class = "col-12 col-md-5 mt-0"><span class="font-weight-bold">Email:  </span><?php echo$templateParams["account"]["Email"]?></div>
            </div>
