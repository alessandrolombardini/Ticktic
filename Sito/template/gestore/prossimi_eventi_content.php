<div class="row p-0 m-0">
  ...
  <div class="col-10 col-md-10 p-0 m-0">
    ...
    <?php foreach ($templateParams["prossimiEventi"] as $evento) :?>
        <div class="event col-12 col-md-6 col-xl-3 col-lg-3 shadow-sm pl-0 pr-0 ml-0 mr-0 pt-2 pb-2 mt-3 mb-4 bg-white rounded border-dark d-inline-block">
            ...
            <div class="col-12 m-0 p-0 text-center">
                <a class="col-4 p-0 m-0" href="./inserisci_evento.php?action=2&id=<?php echo $evento["IDEvento"]?>">
                ...
                <a class="col-4 p-0 m-0" href="?deleteID=<?php echo $evento["IDEvento"]?>">
                    <button class="purple-btn p-1 mt-2 pr-3 pl-3 d-inline-block font-little shadow-sm rounded-pill">Elimina Evento</button>
                </a>
                <a class="col-4 p-0 m-0" href="crea_notifica_organizzatore.php?id=<?php echo $_SESSION["id"]?>&IDEvento=<?php echo $evento["IDEvento"]?>">
