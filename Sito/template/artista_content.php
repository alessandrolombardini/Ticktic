<div class="row mt-3">
    ...
    <div class="col-10 col-md-8">
        <div class="container-fluid text-center "> <!-- Foto e descrizione del gruppo musicale -->
            ...
            <h3>Foo Fighters</h3>
            <p class="text-black-50 font-description  close-lines mb-3 px-5">I Foo Fighters sono un gruppo musicale alternative rock statunitense fondato a Seattle nel 1994 dal musicista Dave Grohl, ex batterista dei Nirvana.</p>
        </div>
        <div class="my-3"> <!-- Intestazione eventi dell'artista -->
            <h3 class ="d-inline">Eventi Artista</h3> 
            <p class="text-black-50 d-inline">(1 Risultato)</p>
        ...
        <div class="row">
            <div class="col-12 col-xl-6">
                <div class="card m-1" >
                    <div class="card-body">
                        <div class="row h-100 justify-content-beetween no-gutters">
                            <div class="col-5 col-sm-7 col-xl-5 mt-xl-2 mt-md-2">
                                <img class="img-fluid rounded" src="./images/eventi/salmo.jpg" alt="salmo"/>
                            </div>

                            <div class="col-auto ml-auto mt-sm-3 mt-xl-1 mt-md-5 mr-3 mr-md-3">
            ...
            <div class="col-12 col-xl-6">
                <div class="card m-1" >
                    <div class="card-body">
                        <div class="row h-100 justify-content-beetween no-gutters">
                            <div class="col-5 col-sm-7 col-xl-5 mt-xl-2 mt-md-2">
                                <img class="img-fluid rounded" src="./images/eventi/salmo-estere-biglietti.jpg" alt="salmo"/>
                            </div>
