<div class="row">
  ...
  <div class="col-12 col-md-10">
    <div class="row mb-md-3 mb-0 mt-5 align-items-end">
        <p class="titolo_sezioni col-7 col-md-7 mt-2 mb-0">Nuove notifiche</p>
        <a class="col-md-5 col-5 text-right pt-3 cursor-pointer purple-black-link font-weight-bold" href="storico_notifiche.php"> Vai allo storico notifiche </a>
    </div>
    <hr class="mt-1 mx-2"/>
                ...
                <div class="notifica">
                    <div class="roundend-corners col-md-12 bg-white border mt-2 mb-4 px-4 py-3 shadow-sm">
                        <div class="row m-0 p-0 d-block float-right">
                            <a data-IDNotificaPersonale="<?php echo $notifica["IDNotificaPersonale"] ?>" class="text-right m-0 p-0 click_nuove_notifiche cursor-pointer"><span class="fas fa-times color-purple fa-2x"></span></a>
                        </div>
